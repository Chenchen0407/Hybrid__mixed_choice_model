...
apollo_control = list(
  modelName       = "MHCM",
  modelDescr      = "Mixed hybrid choice model",
  indivID         = "ID",
  nCores          = 14, 
  outputDirectory = "output_MHCM6"
)
...
apollo_draws = list(
  ...
  interNDraws=200,          
  interUnifDraws=c(),      
  interNormDraws=c("eta1","eta2","eta_risk1","eta_risk2","eta_risk3","eta_will1","eta_will2","eta_will3","eta_will4","draws_asc_s","draws_growing_rate","draws_purchase_price","draws_access_time"), 
  intraDrawsType="",
  intraNDraws=0,          
  intraUnifDraws=c(),     
  intraNormDraws=c()      
...
### Estimate model
model <- apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs, estimate_settings = list(maxIterations = 300,scaleAfterConvergence = FALSE))
# ################################################################# #
#### MODEL OUTPUTS                                               ####
# ################################################################# #
